def dashboard_jalan_lingkungan():
    ...
    def load_data():
        return pd.read_excel("DATA JALAN LINGKUNGAN.xlsx")
    ...
    def render_peta(df_map):
        ...
        for col in ['LAT AWAL', 'LNG AWAL', 'LAT AKHIR', 'LNG AKHIR']:
            df_map[col] = pd.to_numeric(df_map[col], errors='coerce')

        # Drop baris dengan nilai koordinat yang tidak valid (NaN)
            ...
            for _, row in map_df.iterrows():
                ...
                folium.PolyLine(
                    ...
                    popup=folium.Popup(f"""
                        ...
                        <b>Ruas:</b> {row.get('NAMA RUAS JALAN LINGKUNGAN', '')}<br>
    ...
    st.title("🏘️ Dashboard Kondisi Jalan Lingkungan - Provinsi Jawa Barat")
    st.markdown("Analisis visual interaktif kondisi jalan lingkungan.")
    ...
    if "filtered_df" in st.session_state:
        ...
        with tab1:
            ...
            total_panjang = df_metrics['TOTAL PANJANG JALAN (meter)'].sum()
                ...
                <div class="ringkasan-box">
                    ...
                    <div class="ringkasan-grid">
                        ...
                        <div class="card bg2">
                            ...
                            <div class="card-value">{rb_row['NAMA RUAS JALAN LINGKUNGAN']}</div>
                        </div>
                        <div class="card bg2">
        ...
        with tab2:
            ...
            grouping = 'KABUPATEN'
            if selected_desa != "Semua":
                grouping = 'NAMA RUAS JALAN LINGKUNGAN'
        ...
        with tab4:
            st.subheader("🗺️ Peta Jalan Lingkungan")
